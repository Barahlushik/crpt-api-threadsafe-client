...
public class CrptApi
{
    ...
    public CreateDocumentResponse createDocument(Object productDocument, String signatureBase64)
        ...
        Optional<String> raw = Optional.ofNullable(response.body()).filter(s -> !s.isEmpty());
        CreateDocumentResponse result = new CreateDocumentResponse(response.statusCode(), raw);
        raw.ifPresent(b -> {
            try {
    ...
    public static final class Builder {
        ...
        /** Security (по умолчанию — без авторизации). */
        ...
        public Builder baseUri(URI baseUri) { this.baseUri = Objects.requireNonNull(baseUri); return this; }
        public Builder createPath(String path) { this.createPath = Objects.requireNonNull(path); return this; }
        public Builder pgQuery(String pg) { this.pgQuery = pg; return this; }
        public Builder productGroup(String productGroup) { this.productGroup = productGroup; return this; }
        public Builder bearer(String token) { this.authProvider = AuthProvider.bearer(token); return this; }
        public Builder authProvider(AuthProvider provider) { this.authProvider = Objects.requireNonNull(provider); return this; }
        public Builder requestTimeout(Duration timeout) { this.requestTimeout = Objects.requireNonNull(timeout); return this; }
        public Builder httpClient(HttpClient httpClient) { this.httpClient = Objects.requireNonNull(httpClient); return this; }
        public Builder objectMapper(ObjectMapper mapper) { this.objectMapper = Objects.requireNonNull(mapper); return this; }

        public CrptApi build() { return new CrptApi(this); }
    }
    ...
    /**
     * Пример схемы бизнес сущности взятый из документации.
     * {
     *     "description": {
    ...
    public static class Document {
        ...
        @JsonProperty("doc_type") private DocType docType;
        ...
        @JsonProperty("production_date") private String productionDate;
        ...
        public Document setDescription(Description v)        { this.description = v; return this; }
        public Document setDocId(String v)                   { this.docId = v; return this; }
        public Document setDocStatus(String v)               { this.docStatus = v; return this; }
        public Document setDocType(DocType v)                 { this.docType = v; return this; }
        public Document setImportRequest(Boolean v)          { this.importRequest = v; return this; }
        public Document setOwnerInn(String v)                { this.ownerInn = v; return this; }
        public Document setParticipantInn(String v)          { this.participantInn = v; return this; }
        public Document setProducerInn(String v)             { this.producerInn = v; return this; }
        public Document setProductionDate(String v)          { this.productionDate = v; return this; }
        public Document setProductionType(String v)          { this.productionType = v; return this; }
        public Document setProducts(java.util.List<Product> v){ this.products = v; return this; }
        public Document setRegDate(String v)                 { this.regDate = v; return this; }
        public Document setRegNumber(String v)               { this.regNumber = v; return this; }
    ...
    public static final class Description {
        ...
        public String getParticipantInn()              { return participantInn; }
        public Description setParticipantInn(String v) { this.participantInn = v; return this; }
    }
    ...
    public static final class Product {
        ...
        @JsonProperty("certificate_document_date") private String certificateDocumentDate;
        ...
        public Product setCertificateDocument(String v)       { this.certificateDocument = v; return this; }
        public Product setCertificateDocumentDate(String v)   { this.certificateDocumentDate = v; return this; }
        public Product setCertificateDocumentNumber(String v) { this.certificateDocumentNumber = v; return this; }
        public Product setOwnerInn(String v)                  { this.ownerInn = v; return this; }
        public Product setProducerInn(String v)               { this.producerInn = v; return this; }
        public Product setProductionDate(String v)            { this.productionDate = v; return this; }
        public Product setTnvedCode(String v)                 { this.tnvedCode = v; return this; }
        public Product setUitCode(String v)                   { this.uitCode = v; return this; }
        public Product setUituCode(String v)                  { this.uituCode = v; return this; }
    }
    ...
    /**
     * # DTO: запрос к /documents/create
     */
    @JsonInclude(JsonInclude.Include.NON_NULL)
    private static final class CreateDocumentRequest {

        @JsonProperty("document_format") final String documentFormat;
        @JsonProperty("product_document") final String productDocumentBase64;
        @JsonProperty("product_group") final String productGroup;
        @JsonProperty("signature") final String signatureBase64;
    ...
    public static final class CreateDocumentResponse {
        ...
        public Optional<String> getRawBody() { return rawBody; }
    ...
    private static final class RateLimiter {
        ...
        private long waitNanosIsSafe(long waitNanos) {
            final long MAX_TIME_FOR_WAIT = TimeUnit.SECONDS.toNanos(10);
            return Math.min(waitNanos, MAX_TIME_FOR_WAIT);
        }
    ...
    /**
     * Security Provider, торчащий наружу интерфейс, for example ...
     */
